...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="border-b border-[#2A3362] bg-[#12172B]/95 backdrop-blur-sm px-6 py-3.5 sticky top-0 z-40">
      <div className="max-w-[1720px] mx-auto flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4">
        {/* Brand & Context */}
        <div className="flex flex-wrap items-center gap-4">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-[#E8A33D] flex items-center justify-center font-black text-[#12172B] text-lg shadow-sm font-display">
              R
            </div>
            <div>
              <div className="flex items-center gap-2.5">
                ...
                <a
                  href="/"
                  className="text-xs font-mono px-2.5 py-0.5 rounded text-[#7E85A6] hover:text-[#E8A33D] hover:bg-[#1B2140] border border-transparent hover:border-[#2A3362] transition-colors"
                >
                  ← Overview
                </a>
              </div>
              <p className="text-xs text-[#B4B9D2] mt-0.5">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#E8A33D]/10 border border-[#E8A33D]/30 text-[#E8A33D] text-xs font-medium">
            <ShieldAlert className="w-4 h-4 text-[#E8A33D] flex-shrink-0" />
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-lg text-xs font-medium bg-[#1B2140] hover:bg-[#222950] text-[#F2F0EA] border border-[#2A3362] transition-colors shadow-sm"
          >
          ...
          <button
            ...
            className="p-2 rounded-lg text-[#B4B9D2] hover:text-[#F2F0EA] bg-[#1B2140] hover:bg-[#222950] border border-[#2A3362] transition-colors disabled:opacity-50"
          >
